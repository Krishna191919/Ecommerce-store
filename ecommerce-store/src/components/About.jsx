...
const user = {
  ...
  bio: "A passionate web developer with a love for creating dynamic and responsive web applications.",
  skills: ["JavaScript", "React", "Node.js", "CSS", "HTML"],
  location: "Kathmandu, Nepal",
  email: "krishnachaudhary191919@gmail.com",
  avatar: "https://ui-avatars.com/api/?name=Krishna+Chaudhary",
};
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10 animate-fade-in">
        ...
        <p className="text-lg md:text-xl leading-relaxed text-gray-700 text-center animate-fade-in">
          We help businesses grow through powerful design and modern
          development.
          <br />
